...
import datetime, argparse, socket, errno
...
"""
    ...
    parser.add_argument('addrs',nargs='*', help='host:ports, host is optional')
    addresses = parser.parse_args().addrs
...
class PoetrySocket(object):
    ...
    def doRead(self):
        ...
        while True: # we're just reading everything (blocking) -- broken! --modified!
            try :
        ...
        if not bytes:
            ...
            print  msg % (self.task_num, len(poem_part), self.format_addr())
